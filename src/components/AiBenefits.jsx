...
function AiBenefits() {
  return (
    <>
      <section
        className='app-container mt-15 mx-3 lg:m-auto py-16 bg-gradient-to-br from-dark to-gray-900 rounded-xl text-white'
        id='benefits'>
        ...
        <div className="max-w-375 cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-15">
          <BenefitCard />
        </div>
      </section>
    </>
