...
function AiTypes() {
  return (
    <>
      <div className="p-3 pt-12 w-full heading text-center space-y-2">
      ...
      <div className="cards lg:px-32 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 p-3 my-5 gap-8">
        <TypeCard />
      </div>
    </>
  )
